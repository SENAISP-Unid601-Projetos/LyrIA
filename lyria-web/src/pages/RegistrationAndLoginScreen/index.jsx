    ...
    <div className="login-body">
      <div className={`container ${isRegisterActive ? 'register-active' : ''}`}>
        ...
        <div className="form-wrapper">
          {/* Formulário de Login */}
          <div className={`form login-form ${isRegisterActive ? 'hidden' : ''}`}>
            <h2>Login</h2>
          ...
          <div className={`form register-form ${isRegisterActive ? '' : 'hidden'}`}>
            <h2>CADASTRAR-SE</h2>
            
            <div className="input-field">
              <div className="input-decoration"></div>
              <input type="text" placeholder="Nome" className="compact-input" required />
            </div>
            
            <div className="input-field">
              <div className="input-decoration"></div>
              <input type="email" placeholder="Email" className="compact-input" required />
            </div>
